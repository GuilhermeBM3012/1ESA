...
while True:
    if usuario == 'funcionario':
        operacao = forca_opcao('Qual operacao sera realizada? ', ['Cadastrar', 'Remover', 'Atualizar'])
        ...
        if encerrar == 'encerrar':
            print(f'Vc vai levar {list(carrinho['Itens'].keys())[0]} na {carrinho['Endereço']['logradouro']}')
            print(carrinho)
